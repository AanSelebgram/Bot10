...
helpMessage ="""x ==== ꧁ Key of BӨŦ ꧂ 􀨁􀄻double thumbs up􏿿􀜁􀅔􀜁􀅔Har Har􏿿 === x
...
admin=["u8996c744f260a1bb693578eb00ab52c4"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def autolike():
	...
	if hasil ['result']['posts'][zx]['postinfo']['liked']== False:
		try:
			cl.like(hasil['result']['posts'][zx]['userinfo']['mid'],hasil['result']['posts'][zx]['posts']['postid'],lineType=1200)
			cl.comment(hasil['result']['posts'][zx]['userinfo']['mid'],hasil['result']['posts'][zx]['postinfo']['postid'],"Auto Like By ꧁To'if꧂\n\nhttp://line.me/ti/p/%Toifamri")
			kk.like(hasil['result']['posts'][zx]['userinfo']['mid'],hasil['result']['posts'][zx]['posts']['postid'],lineType=1200)
			kk.comment(hasil['result']['posts'][zx]['userinfo']['mid'],hasil['result']['posts'][zx]['postinfo']['postid'],"Auto Like By ꧁To'if꧂\n\nhttp://line.me/ti/p/%Toifamri")
			print "Like"
		except:
		 pass
		else:
